        ...
        <div className="min-h-screen bg-gray-950 text-white py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-gray-800 p-8 rounded-2xl shadow-lg">
                    ...
                    <h2 className="text-2xl font-semibold mb-4">What This Site Is For</h2>
                    <p className="text-lg mb-6">
                    ...
                    <h2 className="text-2xl font-semibold mb-4">My Journey as a Developer</h2>
                    <p className="text-lg mb-6">
                    ...
                    <h2 className="text-2xl font-semibold mb-4">Technologies & Tools I Use</h2>
                    <p className="text-lg mb-6">
