            ...
            <AnimatePresence>
                {showTooltip && showDetails && isValidTrack && (
                    <motion.div
                        ...
                        className="absolute left-full bottom-full mb-3 ml-4 bg-gradient-to-br from-[#0C0810] to-[#0D0911] rounded-2xl shadow-2xl border border-[#313244] w-72 p-4 z-50 backdrop-blur-xl"
                    >
                        {/* Tooltip arrow */}
