      ...
      <div className="p-6 flex flex-col h-full relative z-10 space-y-8">
        ...
        <div className="relative">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="relative flex-shrink-0 group">
              ...
              {/* Status Node */}
              <div
                className="absolute bottom-0 right-0 w-3 h-3 bg-emerald-500 rounded-full border border-black shadow-[0_0_10px_rgba(16,185,129,0.8)] animate-pulse"
                title="System Online"
              />
            </div>
            ...
            <div className="flex-1 pt-1">
              <h2 className="text-xl font-orbitron font-bold text-white tracking-widest uppercase truncate mb-1 text-shadow-glow">
                Jefino
              </h2>
              <p className="text-[10px] font-mono text-[#8ab8d0] uppercase tracking-wider mb-2">
                @jefino9488
              </p>
          ...
          <p className="mt-4 text-xs font-mono text-muted-foreground leading-relaxed border-l-2 border-white/10 pl-3">
            AI & DATA_SCI <span className="text-primary">|</span> FS_ENGINEER{" "}
            <span className="text-primary">|</span> O_SOURCE
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 font-mono">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[9px] text-[#b3bad9] uppercase tracking-widest">
                Followers
              </span>
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        isActive
                          ? "h-full bg-primary top-0 shadow-[0_0_8px_rgba(102,111,188,0.8)]"
                          : "h-0 bg-white/20 top-1/2 group-hover:h-full group-hover:top-0",
                      )}
                    />
                    ...
                    <div
                      className={cn(
                        ...
                        isActive
                          ...
                          : "border-white/10 text-muted-foreground group-hover:border-white/30 group-hover:text-white",
                      )}
                    >
                        ...
                        <span
                          className={cn(
                            ...
                            isActive
                              ...
                              : "text-[#b3bad9] group-hover:text-white",
                          )}
                        >
                          {item.label}
                        </span>
        ...
        <div>
          <div className="flex flex-wrap gap-2 text-xs mb-6">
            ...
            <a
              href="https://github.com/sponsors/Jefino9488"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1">
            <a
              ...
              className="p-2 border border-white/5 bg-black/20 hover:border-primary/40 hover:bg-primary/10 text-white/50 hover:text-primary transition-all"
            >
            ...
            <a
              ...
              className="p-2 border border-white/5 bg-black/20 hover:border-[#0077b5]/50 hover:bg-[#0077b5]/10 text-white/50 hover:text-[#0077b5] transition-all"
            >
            ...
            <a
              href="https://jefino.is-a.dev"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit portfolio website"
              className="p-2 border border-white/5 bg-black/20 hover:border-emerald-500/50 hover:bg-emerald-500/10 text-white/50 hover:text-emerald-500 transition-all"
            >
              <LinkIcon className="w-4 h-4" />
            </a>
            <a
              href="https://x.com/jefino29014673"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit X profile"
              className="p-2 border border-white/5 bg-black/20 hover:border-white/50 hover:bg-white/10 text-white/50 hover:text-white transition-all"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div
              className="p-2 border border-white/5 bg-black/20 text-white/50 cursor-help"
              title="Chennai, IN"
            >
