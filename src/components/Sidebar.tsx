            ...
            <div className="p-6 flex flex-col h-full relative z-10 space-y-8">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1">
                        <a href="mailto:jefinojacob9488@gmail.com" aria-label="Email Jefino" className="p-2 border border-white/5 bg-black/20 hover:border-primary/40 hover:bg-primary/10 text-white/50 hover:text-primary transition-all">
                            <Mail className="w-4 h-4" />
                        </a>
                        <a href="https://linkedin.com/in/jefino9488" target="_blank" rel="noopener noreferrer" aria-label="Visit LinkedIn profile" className="p-2 border border-white/5 bg-black/20 hover:border-[#0077b5]/50 hover:bg-[#0077b5]/10 text-white/50 hover:text-[#0077b5] transition-all">
                            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                        </a>
                        <a href="https://jefino.is-a.dev" target="_blank" rel="noopener noreferrer" aria-label="Visit portfolio website" className="p-2 border border-white/5 bg-black/20 hover:border-emerald-500/50 hover:bg-emerald-500/10 text-white/50 hover:text-emerald-500 transition-all">
                            <LinkIcon className="w-4 h-4" />
                        </a>
                        <a href="https://x.com/jefino29014673" target="_blank" rel="noopener noreferrer" aria-label="Visit X profile" className="p-2 border border-white/5 bg-black/20 hover:border-white/50 hover:bg-white/10 text-white/50 hover:text-white transition-all">
