          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              >
                ...
                <item.icon
                  className={`relative z-10 h-6 w-6 mb-3 ${item.color} drop-shadow-[0_0_10px_rgba(255,255,255,0.1)] group-hover:drop-shadow-[0_0_15px_currentColor] group-hover:scale-110 transition-all duration-500`}
                />
                ...
                <span className="relative z-10 text-[10px] font-mono tracking-widest text-[#b3bad9] group-hover:text-white transition-colors">
                  {item.label}
                </span>
              </motion.div>
            ))}
