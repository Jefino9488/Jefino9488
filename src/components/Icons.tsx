...
export const ExpressIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      d="M7 12H17M7 12L10 9M7 12L10 15"
      stroke="#000000"
      strokeWidth="1.5"
      strokeLinecap="round"
...
export const JavaIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      d="M10 10V14C10 14 10 15 11 15H13C14 15 14 14 14 14V10"
      stroke="#FFFFFF"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const GitIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M21.62 11.11L12.89 2.38C12.4 1.89 11.6 1.89 11.11 2.38L9.27 4.22L11.54 6.49C12.04 6.31 12.62 6.42 13.01 6.81C13.4 7.2 13.51 7.78 13.33 8.28L15.5 10.45C16 10.27 16.58 10.38 16.97 10.77C17.55 11.35 17.55 12.28 16.97 12.86C16.39 13.44 15.46 13.44 14.88 12.86C14.46 12.44 14.37 11.81 14.6 11.31L12.56 9.27V15.57C12.72 15.65 12.87 15.76 13 15.89C13.58 16.47 13.58 17.4 13 17.98C12.42 18.56 11.49 18.56 10.91 17.98C10.33 17.4 10.33 16.47 10.91 15.89C11.08 15.72 11.28 15.6 11.5 15.52V9.17C11.28 9.09 11.08 8.97 10.91 8.8C10.49 8.38 10.4 7.75 10.63 7.25L8.39 5.01L2.38 11.11C1.89 11.6 1.89 12.4 2.38 12.89L11.11 21.62C11.6 22.11 12.4 22.11 12.89 21.62L21.62 12.89C22.11 12.4 22.11 11.6 21.62 11.11Z"
      fill="#F05032"
    />
  </svg>
);
